...
type
  ...
  public
    ...
    function contientCle(cle:string): boolean;
...
for i:=0 to felems.Count-1 do
 begin
 p:= felems[i];
 t.Add(p^.Cle + ' = '+p^.Valeur);
 end;
result:=t;

end;

function TableauAssociatif.contientCle(cle:string):boolean;
var i:integer;
    p:PElementTableauAssociatif;
begin
result:=false;
